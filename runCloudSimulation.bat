...
set /P increaseOption= Please enter the which network elements to increase (Clients, Routers, or Both):
:: Set the number of clients
set /a maxClients= 1000
set /a maxRouters= 100
